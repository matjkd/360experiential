...
<div style="position:relative; margin-top: 20px;"  class="sixteen columns"> 
    ...
    <img style="text-align: center; margin-top:25px;" src="<?=base_url()?>images/backgrounds/horizontalLine.png" />
...
<div  class="eight columns" style="float:right; text-align: right;" id="smallprint">
    &copy; Access 360 Ltd
</div>
