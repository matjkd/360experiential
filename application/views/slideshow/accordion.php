...
<div id="accordion-1" style="margin-bottom:100px;">
	...
	<?php foreach($case_studies as $row):?>
		...
		<?php if($row->image_1 !="") {?>
		<img height="110px"  alt="images" src="https://s3-eu-west-1.amazonaws.com/access360site/thumbs/<?=$row->image_1?>" />
		<?php }?>
		
		
		<?php if($row->image_2 !="") {?>
		<img height="110px"  alt="images" src="https://s3-eu-west-1.amazonaws.com/access360site/thumbs/<?=$row->image_2?>"/>
		<?php }?>
		
		<?php if($row->image_3 !="") {?>
		<img height="110px" alt="images" src="https://s3-eu-west-1.amazonaws.com/access360site/thumbs/<?=$row->image_3?>"/>
		<?php }?>
		</div>
